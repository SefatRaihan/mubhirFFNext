...
export default function ArAboutUsPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "نعم، تقدر تبدأ بتجربة مجانية لمدة ثلاثة أيام للتعرف على طريقة عمل مبهر وتجربة بعض الأسئلة والميزات قبل الاشتراك.",
    },
    {
      ...
      <header className="bg-linear-to-tr from-[#2A056D] to-[#6F0767] text-white mb-4 md:m-4 rounded-0 md:rounded-2xl overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div className="relative text-center mt-16 md:mt-[128px]">
            ...
            <div
              className="hero-button mt-6 flex justify-center items-center space-x-reverse space-x-4 cursor-pointer"
            >
          ...
          <div className="mx-6 md:mx-[48px] mt-24 md:mt-[206px] flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
            ...
            <div
              className="hero-social flex flex-wrap justify-center md:justify-start gap-3 md:gap-4 space-x-reverse order-2 md:order-2 mt-6 md:mt-0"
